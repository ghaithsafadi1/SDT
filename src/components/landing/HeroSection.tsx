...
import heroLogo from "../../assets/logonoback.png";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
          ...
          <div className="space-y-4 max-w-4xl">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight">
              ...
              <span className="gradient-text text-glow">
                Resilient Digital Syria
              </span>
            </h1>

            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Empowering Syria's digital future by connecting global
              cybersecurity expertise with local talent, building national
              capacities, and providing ethical career paths.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  size="lg"
                  className="glow-primary animate-pulse-glow bg-primary hover:bg-primary/90 text-primary-foreground font-semibold px-8 py-6 text-lg rounded-full transition-all duration-300 hover:scale-105"
                >
            ...
            <Button
              variant="outline"
              size="lg"
              className="border-primary/50 text-foreground hover:bg-primary/10 hover:border-primary px-8 py-6 text-lg rounded-full transition-all duration-300"
              onClick={() =>
